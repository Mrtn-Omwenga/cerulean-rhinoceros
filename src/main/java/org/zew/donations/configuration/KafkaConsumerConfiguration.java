...
import org.zew.donations.messaging.KafkaDonationDeserializer;
...
public class KafkaConsumerConfiguration {
    ...
    public Map<String, Object> consumerConfig() {
        return Map.of(
                ...
                ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, KafkaDonationDeserializer.class,
                JsonDeserializer.TRUSTED_PACKAGES, "org.zew.donations.model",
                JsonDeserializer.VALUE_DEFAULT_TYPE, DonationDto.class.getName());
    }
